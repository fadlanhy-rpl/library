...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laravel\library\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laravel\\library\\public\\storage',
...
'register','books.index','books.show','admin.dashboard',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.books.index','admin.books.create','admin.books.store',
'admin.books.show','admin.books.edit','admin.books.update','admin.books.destroy','admin.categories.index',
'admin.categories.create','admin.categories.store','admin.categories.show','admin.categories.edit','admin.categories.update',
'admin.categories.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.books.create','admin.books.edit','admin.books.index','admin.books.show','admin.categories.create',
'admin.categories.edit','admin.categories.index','admin.dashboard','admin.users.create','admin.users.edit',
'admin.users.index','auth.login','layouts.app','layouts.header','layouts.sidebar',
